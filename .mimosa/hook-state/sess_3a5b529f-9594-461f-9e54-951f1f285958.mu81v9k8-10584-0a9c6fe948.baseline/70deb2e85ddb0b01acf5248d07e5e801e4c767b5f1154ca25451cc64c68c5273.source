/**
 * 璃光 Aurora · app.js
 * 玻璃拟态暗夜风：左侧玻璃导航栏 + 极光背景 + 悬浮播放 Dock。
...
(function () {
  ...
  const bgEl = el("div", { class: "aurora", "aria-hidden": "true" },
    el("div", { class: "blob b1" }), el("div", { class: "blob b2" }),
    el("div", { class: "blob b3" }), el("div", { class: "blob b4" }),
    el("div", { class: "grain" }));
