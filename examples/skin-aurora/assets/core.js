/**
 * 皮肤共享引擎 SkinCore（三款皮肤共用，逻辑与 skin-dev / 默认皮肤对齐）。
 *
...
(function () {
  ...
  async function listSkins() {
    if (demo) {
      return [
        { id: "default", name: "巨应壁纸默认皮肤", version: "4.0.1", author: "GiantappMan", description: "内置默认界面", type: "app", entry: "index.html", builtin: true, valid: true, invalidReason: null },
        { id: "aurora", name: "璃光 Aurora", version: meta.version, author: "you", description: "玻璃拟态 · 暗夜极光", type: "app", entry: "index.html", builtin: false, valid: true, invalidReason: null },
        { id: "paper", name: "素笺 Paper Ink", version: meta.version, author: "you", description: "纸感编辑部极简", type: "app", entry: "index.html", builtin: false, valid: true, invalidReason: null },
        { id: "term", name: "终端 Term", version: meta.version, author: "you", description: "单色 HUD 极客终端", type: "app", entry: "index.html", builtin: false, valid: true, invalidReason: null },
      ];
    }
  ...
  function mockConfig() {
    return {
      ...
      Appearance: { theme: "zinc", mode: (window.SKIN_META && window.SKIN_META.mode) || "dark", skin: (window.SKIN_META && window.SKIN_META.id) || "aurora" },
    };
  }
