  ...
  function openSettingDialog(w) {
    ...
    openDialog((box, close) => {
      ...
      function rebuild() {
        ...
        if (type === 3) {
          bodyEl.append(tfield(SC.t("set.player"), selectEl([{ value: 0, label: SC.t("set.engine0") }, { value: 2, label: SC.t("set.engine2") }, { value: 1, label: SC.t("set.engine1") }], cur.videoPlayer, (v) => { cur.videoPlayer = Number(v); })));
  ...
  function wallpaperTab(panel) {
    ...
    panel.append(
      ...
      el("div", { class: "tcfg-block" },
        ...
        cfgLine(SC.t("cfg.player"), selectEl([{ value: 2, label: SC.t("set.engine2") }, { value: 1, label: SC.t("set.engine1") }], c.defaultVideoPlayer, (v) => { c.defaultVideoPlayer = Number(v); SC.saveConfig("Wallpaper", { defaultVideoPlayer: Number(v) }); syncMpv(); }))));
